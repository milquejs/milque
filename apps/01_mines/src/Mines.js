...
function getNeighbors(tileX, tileY, chunkWidth, chunkHeight) {
  ...
  if (tileX > 0 && tileY < chunkHeight - 1)
    dst.push(tileIndex - 1 + chunkWidth);
  if (tileX < chunkWidth - 1 && tileY < chunkHeight - 1)
    dst.push(tileIndex + 1 + chunkWidth);
  return dst;
}
