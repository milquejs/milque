...
{
    ASSETS.TILE_IMAGE = await AssetLoader.loadAsset('image:mines/tile.png', {}, ASSETS_ROOT);
    ASSETS.NUMS_IMAGE = await AssetLoader.loadAsset('image:mines/nums.png', {}, ASSETS_ROOT);
    ASSETS.MARK_IMAGE = await AssetLoader.loadAsset('image:mines/flag.png', {}, ASSETS_ROOT);
    ASSETS.LOADED = true;
}
