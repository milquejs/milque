...
async function main()
{
    ...
    const tileRegistry = {
        0: { render(ctx) { ctx.fillStyle = 'red'; ctx.fillRect(0, 0, 16, 16); } },
        1: { render(ctx) { ctx.fillStyle = 'blue'; ctx.fillRect(0, 0, 16, 16); } },
        2: { render(ctx) { ctx.fillStyle = 'green'; ctx.fillRect(0, 0, 16, 16); } },
        3: { render(ctx) { ctx.fillStyle = 'saddlebrown'; ctx.fillRect(0, 0, 16, 16); } },
        4: { render(ctx) { ctx.fillStyle = 'dodgerblue'; ctx.fillRect(0, 0, 16, 16); } },
        5: { render(ctx) { ctx.fillStyle = 'white'; ctx.fillRect(0, 0, 16, 16); } },
        6: { render(ctx) { ctx.fillStyle = 'yellow'; ctx.fillRect(0, 0, 16, 16); } },
    };
    const tileMap = [
        0, 1, 1, 0,
        0, 0, 0, 0,
