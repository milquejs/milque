...
export class ConsoleElement extends HTMLElement {
  static get [customEvents]() {
    return ['input', 'command', 'autocomplete'];
  }
  ...
  constructor() {
    ...
    this._scrollBottomElement.addEventListener(
      'click',
  ...
  onOutputScroll(e) {
    ...
    this._scrollTopElement.classList.toggle(
      'hidden',
      autoscroll || nearBounds || goingDown
    );
    this._scrollBottomElement.classList.toggle(
      'hidden',
      autoscroll || nearBounds || !goingDown
    );
  }
