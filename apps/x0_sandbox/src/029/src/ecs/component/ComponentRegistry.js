...
function validateComponentType(componentType)
{
    ...
    {
        throw new Error('Component type is not in a supported format - must be either a string, symbol, or number.');
    }
}
...
function validateComponentFactory(componentFactory)
{
    ...
    {
        throw new Error('Unexpected factory type - must be a descendent of ComponentFactory.');
    }
}
