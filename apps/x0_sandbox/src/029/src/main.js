...
async function main() {
  ...
  display.addEventListener('frame', (e) => {
    ...
    const moveX =
      input.context.getInputValue('MoveRight') -
      input.context.getInputValue('MoveLeft');
    const moveZ =
      input.context.getInputValue('MoveUp') -
      input.context.getInputValue('MoveDown');
