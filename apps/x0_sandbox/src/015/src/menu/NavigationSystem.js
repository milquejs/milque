...
const { NavigationChangeDestinationCommand } = require('./NavigationChangeDestinationCommand.js');
...
class NavigationSystem extends ModuleSystem
{
    ...
    {
        commandCenter.registerCommand('nav-destination', new NavigationChangeDestinationCommand());
