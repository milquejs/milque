...
function Player(input, x = 0, y = 0) {
  const playerControls = {
    get up() {
      return input.getInput('up').value;
    },
    get down() {
      return input.getInput('down').value;
    },
    get left() {
      return input.getInput('left').value;
    },
    get right() {
      return input.getInput('right').value;
    },
  };
  let player = {
    x,
