...
export const BuildDrag = ButtonBinding.fromBind('build_dragstart', 'Mouse', 'Button0');
export const BuildNextTile = ButtonBinding.fromBind('build_nexttile', 'Keyboard', 'KeyA');
export const BuildPrevTile = ButtonBinding.fromBind('build_prevtile', 'Keyboard', 'KeyD');
