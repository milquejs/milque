...
export function drawBMText(renderer, text, x, y) {
    let rootX = x;
    let rootIndex = 32;
    let spacingX = 13;
    let spacingY = 18;
...
/** @param {FixedSpriteGLRenderer2d} renderer */
export function loadSpritesFromAtlas(renderer, textureUnit, atlas)
{
...
/** @param {FixedSpriteGLRenderer2d} renderer */
export function loadFontSprite(renderer, textureUnit)
{
    let frames = [];
    let w = 8;
    let h = 8;
 ...
 */
export function loadBMFontSprite(renderer, textureUnit, bmFontData) {
    let frames = [];
...
/** @param {FixedSpriteGLRenderer2d} renderer */
export function loadNineSprite(renderer, textureUnit, textureWidth, textureHeight) {
