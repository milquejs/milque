...
export class FixedSpriteGLRenderer2d extends FixedGLRenderer2d
{
     ...
     * @returns {FixedSpriteGLRenderer2d}
     */
    frame(frameName, textureUnit = 0, u = 0, v = 0, s = undefined, t = undefined)
    {
    ...
    draw(spriteName, frameIndex = 0, x = 0, y = 0, angle = 0, scaleX = 1, scaleY = scaleX)
    {
        ...
        drawSprite(gl, this.program, this.meshQuad,
            ...
            this.textureSize,
            this.spriteVector,
            x, y, this.spriteDepth, angle, scaleX, scaleY);
        return this;
    }
}
...
function drawSprite(
    ...
    textureHandle, textureSize, spriteVector, x, y, z, angle, scaleX, scaleY)
{
