...
export const ASSETS = {
  ...
  StarImage: new AssetRef('image:star.png'),
  /** @type {AssetRef<HTMLImageElement>} */
  BlurStrokeImage: new AssetRef('image:blur_stroke.png'),
  /** @type {AssetRef<HTMLImageElement>} */
  CircleImage: new AssetRef('image:circle.png'),
  /** @type {AssetRef<HTMLImageElement>} */
  CloudImage: new AssetRef('image:cloud.png'),
};
