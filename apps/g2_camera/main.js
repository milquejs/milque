...
import { loadOBJ } from '../../packages/lib/src/assets/OBJLoader.js';
...
async function main()
{
    ...
    mat4.fromRotation(cubeModel.transform, MathHelper.toRadians(90), [0, 1, 1]);

    const astroGeometry = await loadOBJ('../../res/webgl/astro2.obj');
    const astroModel = createModel(gl, astroGeometry);
    mat4.fromRotation(astroModel.transform, MathHelper.toRadians(90), [0, 1, 1]);
