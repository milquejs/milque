...
{
    PLACE_SOUNDS.dirt = await Audio.loadAudio('../../res/arroyo/dirt.wav');
    PLACE_SOUNDS.stone = await Audio.loadAudio('../../res/arroyo/stone.wav');
    PLACE_SOUNDS.fluid = await Audio.loadAudio('../../res/arroyo/waterpop.wav');
    PLACE_SOUNDS.metal = await Audio.loadAudio('../../res/arroyo/ding.wav');
}
