  ...
  display.addEventListener('frame', ({ deltaTime }) => {
    ...
    for (let cube of cubes) {
      ctx
        .attribute(
          'a_position',
          cubeMesh.position.type,
          cubeMesh.position.handle
        )
        .attribute(
          'a_texcoord',
          cubeMesh.texcoord.type,
          cubeMesh.texcoord.handle
        )
        ...
        .draw(
          gl,
          gl.TRIANGLES,
          cubeMesh.elementOffset,
          cubeMesh.elementCount,
          cubeMesh.element.handle
        );
    }
  });
}
