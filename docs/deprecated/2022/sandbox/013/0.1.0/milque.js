var self = /*#__PURE__*/ Object.freeze({
  ...
  get MIN_CONTEXT_PRIORITY() {
    return MIN_CONTEXT_PRIORITY;
  },
  get MAX_CONTEXT_PRIORITY() {
    return MAX_CONTEXT_PRIORITY;
  },
  get createContext() {
  ...
  get AbstractInputAdapter() {
    return AbstractInputAdapter;
  },
  get ActionInputAdapter() {
    return ActionInputAdapter;
  },
  get DOUBLE_ACTION_TIME() {
    return DOUBLE_ACTION_TIME;
  },
  get DoubleActionInputAdapter() {
    return DoubleActionInputAdapter;
  },
  get RangeInputAdapter() {
    return RangeInputAdapter;
  },
  get StateInputAdapter() {
...
var INNER_STYLE =
  '\n<style>\n    :host {\n        display: inline-block;\n        color: #555555;\n    }\n    div {\n        display: flex;\n        position: relative;\n        width: 100%;\n        height: 100%;\n    }\n    canvas {\n        background: #000000;\n        margin: auto;\n    }\n    label {\n        font-family: monospace;\n        color: currentColor;\n        position: absolute;\n    }\n    #title {\n        left: 0.5rem;\n        top: 0.5rem;\n    }\n    #fps {\n        right: 0.5rem;\n        top: 0.5rem;\n    }\n    #dimension {\n        left: 0.5rem;\n        bottom: 0.5rem;\n    }\n    .hidden {\n        display: none;\n    }\n    :host([debug]) div {\n        outline: 8px dashed rgba(0, 0, 0, 0.4);\n        outline-offset: -4px;\n        background-color: rgba(0, 0, 0, 0.1);\n    }\n    :host([mode="'
    ...
    .concat(MODE_FIT, '"]), :host([mode="')
    .concat(MODE_CENTER, '"]), :host([mode="')
    .concat(
      MODE_STRETCH,
  ...
  (function (_HTMLElement) {
    ...
    _createClass(DisplayPort, null, [
      {
        ...
        get: function get() {
          return [
            'width',
            'height',
            'disabled', // NOTE: For debuggin purposes...
    ...
    function DisplayPort() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(DisplayPort).call(this)
      );
      ...
      _this.shadowRoot.innerHTML = '<div>'
        .concat(INNER_STYLE)
        .concat(INNER_HTML, '</div>');
          ...
          switch (attribute) {
            ...
            case 'class':
              this._titleElement.innerHTML = 'display-port'
                .concat(this.className ? '.' + this.className : '')
                .concat(
      ...
      },
      {
        ...
        value: function update(now) {
          ...
          if (this.debug) {
            ...
            var frames =
              dt <= 0 ? '--' : String(Math.round(1000 / dt)).padStart(2, '0');
            ...
            if (this.mode === MODE_NOSCALE) {
              ...
              var _result = ''
                .concat(this._width, 'x')
                .concat(this._height, '|')
                .concat(this.shadowRoot.host.clientWidth, 'x')
                .concat(this.shadowRoot.host.clientHeight);
      ...
      },
      {
        ...
        value: function updateCanvasSize() {
          ...
          if (canvas.width !== canvasWidth || canvas.height !== canvasHeight) {
            ...
            canvas.style = 'width: '
              .concat(canvasWidth, 'px; height: ')
              .concat(canvasHeight, 'px');
            this.dispatchEvent(
  ...
  (function () {
    _createClass(EventKey, null, [
      {
        ...
        value: function parse(eventKeyString) {
          ...
          else source = eventKeyString.substring(0, startCodeIndex); // For ANY code, use `source.mode` or `source[].mode`
          // For ONLY sources and modes for code, use `[code]`

          if (
            startCodeIndex < 0 ||
            endCodeIndex < 0 ||
            startCodeIndex + 1 === endCodeIndex
          )
            code = ANY;
          else
            code = eventKeyString.substring(startCodeIndex + 1, endCodeIndex); // For ANY mode, use `source[code]` or `source[code].`
    ...
    function EventKey(source, code, mode) {
      ...
      this.string = ''
        ...
        .concat(this.code.toString(), '].')
        .concat(this.mode.toString());
    }
    ...
    _createClass(EventKey, [
      {
        ...
        value: function matches(eventKey) {
          if (
            this.source === ANY ||
            eventKey.source === ANY ||
            this.source === eventKey.source
          ) {
            if (
              this.code === ANY ||
              eventKey.code === ANY ||
              this.code === eventKey.code
            ) {
              if (
                this.mode === ANY ||
                eventKey.mode === ANY ||
                this.mode === eventKey.mode
              ) {
                return true;
              }
            }
...
var ActionInputAdapter =
  ...
  (function (_AbstractInputAdapter) {
    ...
    function ActionInputAdapter(eventKeyStrings) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(ActionInputAdapter).call(this, false)
      );
      _this.eventKeys = [];
      ...
      try {
        for (
          var _iterator = eventKeyStrings[Symbol.iterator](), _step;
    ...
    _createClass(ActionInputAdapter, [
      ...
      },
      {
        ...
        value: function update(eventKey) {
          ...
          try {
            for (
              var _iterator2 = this.eventKeys[Symbol.iterator](), _step2;
...
var RangeInputAdapter =
  ...
  (function (_AbstractInputAdapter) {
    ...
    function RangeInputAdapter(eventKeyString) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(RangeInputAdapter).call(this, 0)
      );
...
var StateInputAdapter =
  ...
  (function (_AbstractInputAdapter) {
    ...
    function StateInputAdapter(eventKeyMap) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(StateInputAdapter).call(this, 0)
      );
      _this.eventKeyEntries = [];

      for (
        var _i = 0, _Object$keys = Object.keys(eventKeyMap);
    ...
    _createClass(StateInputAdapter, [
      {
        ...
        value: function update(eventKey) {
          ...
          if (value) {
            ...
            try {
              for (
                var _iterator = this.eventKeyEntries[Symbol.iterator](), _step;
                !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
                _iteratorNormalCompletion = true
              ) {
  ...
  return {
    ...
    setPriority: function setPriority(priority) {
      if (priority > MAX_CONTEXT_PRIORITY || priority < MIN_CONTEXT_PRIORITY) {
        throw new Error(
          'Context priority must be between ['
            .concat(MIN_CONTEXT_PRIORITY, ', ')
            .concat(MAX_CONTEXT_PRIORITY, '].')
        );
      }
    ...
    registerAction: function registerAction(name) {
      for (
        var _len = arguments.length,
          eventKeyStrings = new Array(_len > 1 ? _len - 1 : 0),
          _key = 1;
        _key < _len;
        _key++
      ) {
    ...
    poll: function poll() {
      ...
      try {
        for (
          var _iterator = this.inputs.values()[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
    ...
    update: function update(eventKey, value) {
      ...
      try {
        for (
          var _iterator2 = this.inputs.values()[Symbol.iterator](), _step2;
          !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
          _iteratorNormalCompletion2 = true
        ) {
    ...
    _createClass(Mouse, [
      ...
      },
      {
        ...
        value: function onMouseDown(e) {
          ...
          var result;
          result = this.eventHandler.call(
            this,
            'mouse['.concat(e.button, '].down'),
            true
          );
      ...
      },
      {
        ...
        value: function onMouseMove(e) {
          ...
          this.eventHandler.call(
            this,
            'mouse[pos].x',
            (e.pageX - clientCanvas.offsetLeft) / clientWidth
          );
          this.eventHandler.call(
            this,
            'mouse[pos].y',
            (e.pageY - clientCanvas.offsetTop) / clientHeight
          );
          this.eventHandler.call(
            this,
            'mouse[pos].dx',
            e.movementX / clientWidth
          );
          this.eventHandler.call(
            this,
            'mouse[pos].dy',
            e.movementY / clientHeight
          );
        },
      },
      {
      ...
      },
      {
        ...
        value: function onKeyDown(e) {
          ...
          if (e.repeat) {
            result = this.eventHandler.call(
              this,
              'key['.concat(e.key, '].repeat'),
              true
            );
          } else {
            result = this.eventHandler.call(
              this,
              'key['.concat(e.key, '].down'),
              true
            );
          }
...
function createSource() {
  var result = {
    ...
    poll: function poll() {
      ...
      try {
        for (
          var _iterator = this._contexts[Symbol.iterator](), _step;
          !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
          _iteratorNormalCompletion = true
        ) {
          ...
          if (contexts) {
            ...
            try {
              for (
                var _iterator2 = contexts[Symbol.iterator](), _step2;
    ...
    handleEvent: function handleEvent(eventKeyString, value) {
      ...
      try {
        for (
          var _iterator3 = this._contexts[Symbol.iterator](), _step3;
          ...
          if (contexts) {
            ...
            try {
              for (
                var _iterator4 = contexts[Symbol.iterator](), _step4;
...
var DoubleActionInputAdapter =
  ...
  (function (_ActionInputAdapter) {
    ...
    function DoubleActionInputAdapter(eventKeyStrings) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(DoubleActionInputAdapter).call(this, eventKeyStrings)
      );
      _this.actionTime = 0;
      return _this;
    }
    ...
    _createClass(DoubleActionInputAdapter, [
      {
        ...
        value: function update(eventKey) {
          ...
          try {
            for (
              var _iterator = this.eventKeys[Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
...
var SimpleRandomGenerator =
  ...
  (function (_RandomGenerator) {
    ...
    function SimpleRandomGenerator() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(SimpleRandomGenerator).call(
          this,
...
var EventableInstance = {
  ...
  on: function on(event, callback) {
    ...
    if (!callbacks.has(handle)) {
      ...
      throw new Error(
        "Found callback for event '"
          .concat(event, "' with the same handle '")
          .concat(handle, "'.")
      );
    }
  ...
  off: function off(event, handle) {
    if (this.__events.has(event)) {
      ...
      if (callbacks.has(handle)) {
        ...
        throw new Error(
          "Unable to find callback for event '"
            .concat(event, "' with handle '")
            .concat(handle, "'.")
        );
      }
    } else {
...
function createView() {
  var width =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 640;
  var height =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 480;
...
function drawBufferToCanvas(targetCanvasContext, bufferCanvasElement) {
  ...
  var viewPortWidth =
    arguments.length > 4 && arguments[4] !== undefined
      ? arguments[4]
      : targetCanvasContext.canvas.clientWidth;
  var viewPortHeight =
    arguments.length > 5 && arguments[5] !== undefined
      ? arguments[5]
      : targetCanvasContext.canvas.clientHeight;
...
function setViewTransform(view) {
  ...
  if (camera) {
    ...
    (_view$context = view.context).setTransform.apply(
      _view$context,
      _toConsumableArray(camera.getProjectionMatrix())
    );

    (_view$context2 = view.context).transform.apply(
      _view$context2,
      _toConsumableArray(camera.getViewMatrix())
    );
  } else {
    ...
    _createClass(GameLoop, null, [
      {
        ...
        value: function start() {
          ...
          if (INSTANCES.has(handle)) {
            ...
            var context;
            if (_typeof(handle) === 'object') context = handle;
            else context = {};
    ...
    _createClass(GameLoop, [
      ...
      },
      {
        ...
        value: function run(now) {
          ...
          if (typeof this.gameContext.update === 'function')
            this.gameContext.update.call(this.gameContext, dt);
          this.emit('update', dt);
        },
      ...
      },
      {
        ...
        value: function start() {
          ...
          this.started = true;
          if (typeof this.gameContext.start === 'function')
            this.gameContext.start.call(this.gameContext);
          this.emit('start');
      ...
      },
      {
        ...
        value: function stop() {
          ...
          this.animationFrameHandle = null;
          this.started = false;
          if (typeof this.gameContext.stop === 'function')
            this.gameContext.stop.call(this.gameContext);
          this.emit('stop');
        },
      ...
      },
      {
        ...
        value: function pause() {
          ...
          this.animationFrameHandle = null;
          this.paused = true;
          if (typeof this.gameContext.pause === 'function')
            this.gameContext.pause.call(this.gameContext);
          this.emit('pause');
        },
      ...
      },
      {
        ...
        value: function resume() {
          ...
          this.prevFrameTime = performance.now();
          this.paused = false;
          if (typeof this.gameContext.resume === 'function')
            this.gameContext.resume.call(this.gameContext);
          this.emit('resume');
          this.run(this.prevFrameTime);
        },
      },
...
var EntityQuery =
  ...
  (function () {
    _createClass(EntityQuery, null, [
      ...
      },
      {
        ...
        value: function computeKey(components) {
          ...
          try {
            for (
              var _iterator = components[Symbol.iterator](), _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
              ...
              if (_typeof(component) === 'object' && OPERATOR$1 in component) {
                result.push(
                  component[OPERATOR$1].toString() +
                    getComponentTypeName$1(component)
                );
              } else {
    ...
    function EntityQuery(components) {
      ...
      try {
        for (
          var _iterator2 = components[Symbol.iterator](), _step2;
          !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
          _iteratorNormalCompletion2 = true
        ) {
    ...
    _createClass(EntityQuery, [
      {
        ...
        value: function matches(world, entityId) {
          ...
          if (
            !world.hasComponent.apply(
              world,
              [entityId].concat(_toConsumableArray(this._included))
            )
          )
            return false;
          var _iteratorNormalCompletion3 = true;
          ...
          try {
            for (
              var _iterator3 = Object.getOwnPropertyNames(this._operated)[
                  Symbol.iterator
                ](),
                _step3;
              !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done);
              ...
              if (
                !operatedInfo[HANDLER$1].call(
                  this,
                  world,
                  entityId,
                  operatedInfo.components
                )
              ) {
                return false;
              }
      ...
      },
      {
        ...
        value: function select(world) {
          ...
          try {
            for (
              var _iterator4 = world.getEntityIds()[Symbol.iterator](), _step4;
        ...
        value: function createComponent(
          ...
          if (type === 'object') {
            ...
            if (!('create' in componentType)) {
              throw new Error(
                "Instanced component class '".concat(
                  getComponentTypeName(componentType),
                  "' must at least have a create() function."
                )
              );
            }
          ...
          if (initialValues) {
            ...
            if ('copy' in componentType) {
              ...
              try {
                for (
                  var _iterator =
                      Object.getOwnPropertyNames(initialValues)[
                        Symbol.iterator
                      ](),
                    _step;
        ...
        value: function putComponent(
          ...
          if (this.componentTypeInstanceMap.has(componentType)) {
            componentInstanceMap =
              this.componentTypeInstanceMap.get(componentType);
          } else {
            this.componentTypeInstanceMap.set(
              componentType,
          ...
          if (componentInstanceMap.has(entityId)) {
            throw new Error(
              "Cannot add more than one instance of component class '"
                .concat(getComponentTypeName(componentType), "' for entity '")
                .concat(entityId, "'.")
            );
          }
    ...
    _createClass(EntityWorld, [
      {
        ...
        value: function clear() {
          ...
          try {
            for (
              var _iterator = this.entityManager
                  .getEntityIds()
                  [Symbol.iterator](),
                _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
      ...
      },
      {
        ...
        value: function destroyEntity(entityId) {
          ...
          try {
            for (
              var _iterator2 = this.componentManager
                  .getComponentTypes()
                  [Symbol.iterator](),
                _step2;
              !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done);
              ...
              if (
                this.componentManager
                  .getComponentInstanceMapByType(_componentType)
                  .has(entityId)
              ) {
      ...
      },
      {
        ...
        value: function addComponent(entityId, componentType) {
          ...
          try {
            var component = this.componentManager.createComponent(
              entityId,
              componentType,
              initialValues
            );
            ...
            console.error(
              "Failed to add component '"
                .concat(getComponentTypeName$1(componentType), "' to entity '")
                .concat(entityId, "'.")
            );
            console.error(e);
          }
      ...
      },
      {
        ...
        value: function removeComponent(entityId, componentType) {
          try {
            ...
            this.componentManager.deleteComponent(
              entityId,
              componentType,
              component
            );
            ...
            console.error(
              "Failed to remove component '"
                .concat(
                  getComponentTypeName$1(componentType),
                  "' from entity '"
                )
                .concat(entityId, "'.")
            );
      ...
      },
      {
        ...
        value: function clearComponents(entityId) {
          ...
          try {
            for (
              var _iterator3 = this.componentManager
      ...
      },
      {
        ...
        value: function hasComponent(entityId) {
          for (
            var _len2 = arguments.length,
              componentTypes = new Array(_len2 > 1 ? _len2 - 1 : 0),
              _key2 = 1;
            _key2 < _len2;
            _key2++
          ) {
          ...
          for (
            var _i2 = 0, _componentTypes = componentTypes;
            _i2 < _componentTypes.length;
            _i2++
          ) {
            var _componentType2 = _componentTypes[_i2];
            if (!this.componentManager.hasComponentType(_componentType2))
              return false;
            if (
              !this.componentManager
                .getComponentInstanceMapByType(_componentType2)
                .has(entityId)
            )
              return false;
          }
      ...
      },
      {
        ...
        value: function countComponents(entityId) {
          ...
          try {
            for (
              var _iterator4 = this.componentManager
                  .getComponentInstanceMaps()
                  [Symbol.iterator](),
                _step4;
              !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done);
...
function createQueryOperator(handler) {
  ...
  var result = function result(componentType) {
    ...
    return (
      (_ref = {}),
      _defineProperty(_ref, OPERATOR, key),
      _defineProperty(_ref, HANDLER, handler),
      _defineProperty(_ref, 'component', componentType),
      _ref
    );
...
var Not = createQueryOperator(function NotOperator(
  world,
  entityId,
  componentTypees
) {
  return !world.hasComponent.apply(
    world,
    [entityId].concat(_toConsumableArray(componentTypees))
  );
},
Symbol('!'));
    ...
    _createClass(ComponentBase, [
      {
        ...
        value: function copy(values) {
          ...
          try {
            for (
              var _iterator =
                  Object.getOwnPropertyNames(values)[Symbol.iterator](),
                _step;
              !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
              _iteratorNormalCompletion = true
            ) {
          ...
          if ('defaultValues' in this.constructor) {
            ...
            if (defaultValues === DEFAULT_UNDEFINED) {
              ...
              try {
                for (
                  var _iterator2 =
                      Object.getOwnPropertyNames(this)[Symbol.iterator](),
                    _step2;
                  !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next())
                    .done);
                  _iteratorNormalCompletion2 = true
  ...
  (function () {
    function EntityComponent(world) {
      ...
      if (typeof entityId !== 'undefined') {
        throw new Error(
          'This component cannot be added to an existing entity; it can only initialize itself.'
        );
      }
    ...
    _createClass(EntityComponent, [
      {
        ...
        value: function copy(values) {
          throw new Error(
            'Unsupported operation; cannot be initialized by existing values.'
          );
        },
        /** @override */
      },
...
var EntityBase =
  ...
  (function (_EntityComponent) {
    ...
    function EntityBase(world) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(EntityBase).call(this, world)
      );
      _this.world = world;
      return _this;
    }
...
var HybridEntity =
  ...
  (function (_EntityBase) {
    ...
    function HybridEntity(world) {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(HybridEntity).call(this, world)
      );
      _this.onComponentAdd = _this.onComponentAdd.bind(
        _assertThisInitialized(_this)
      );
      _this.onComponentRemove = _this.onComponentRemove.bind(
        _assertThisInitialized(_this)
      );
    ...
    try {
      var _loop = function _loop() {
        ...
        if (ownProps.includes(prop)) {
          throw new Error(
            "Conflicting property names in entity for component '".concat(
              getComponentTypeName(componentType),
              "'."
            )
          );
      ...
      for (
        var _iterator =
            Object.getOwnPropertyNames(component)[Symbol.iterator](),
          _step;
        !(_iteratorNormalCompletion = (_step = _iterator.next()).done);
        _iteratorNormalCompletion = true
      ) {
...
function drawText(ctx, text, x, y) {
  ...
  var fontSize =
    arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 16;
  var color =
    arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 'white';
  ctx.translate(x, y);
...
function drawBox(ctx, x, y) {
  var radians =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 0;
  var w =
    arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 16;
...
function applyMotion(entity) {
  var inverseFrictionX =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var inverseFrictionY =
    arguments.length > 2 && arguments[2] !== undefined
      ? arguments[2]
      : inverseFrictionX;
...
function drawCircle(ctx, x, y) {
  var radius =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 16;
  var color =
    arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'white';
  var outline =
...
function createCanvas() {
  var width =
    arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 320;
  var height =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : width;
  var parentElement =
    arguments.length > 2 && arguments[2] !== undefined
      ? arguments[2]
      : document.body;
...
function attachCanvas(canvasElement, canvasContext) {
  var width =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 320;
  var height =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : width;
  canvas = canvasElement;
  context = canvasContext;
  canvas.width = width;
...
function createAction() {
  for (
    var _len = arguments.length, eventKeyStrings = new Array(_len), _key = 0;
    _key < _len;
    _key++
  ) {
  ...
  return context$1.registerAction.apply(
    context$1,
    [getNextInputName()].concat(eventKeyStrings)
  );
}
...
export {
  ...
  Display,
  DisplayPort,
  DoubleActionInputAdapter,
  EntityHelper as Entity,
  EntityBase,
  EntityComponent$1 as EntityComponent,
  EntityQuery,
  EntityWorld,
  EventKey,
  Eventable$1 as Eventable,
  GameLoop,
  HybridEntity,
  Input,
  Keyboard,
  MAX_CONTEXT_PRIORITY,
  MIN_CONTEXT_PRIORITY,
  MODE_CENTER,
  MODE_FIT,
  MODE_NOSCALE,
  MODE_STRETCH,
