...
(function () {
  ...
  class QuadRendererBase {
    ...
    constructor(gl) {
      ...
      this._projectionViewMatrix = create();
      /** @private */
    ...
    setProjectionViewMatrix(matrix) {
      copy(this._projectionViewMatrix, matrix);
      return this;
    }
...
void main()
{
  ...
  function GameRenderer(game) {
    ...
    let projectionViewMatrix = create();
    ...
    return function () {
      ...
      multiply(projectionViewMatrix, camera.projectionMatrix, camera.viewMatrix);
