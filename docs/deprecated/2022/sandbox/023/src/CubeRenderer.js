...
export class CubeRenderer {
  constructor(gl, shaderProgram, cubeMeshData) {
    ...
    const positionBufferSource = createBufferSource(
      gl,
      gl.FLOAT,
      cubeMeshData.positions
    );
    ...
    const texcoordBufferSource = createBufferSource(
      gl,
      gl.FLOAT,
      cubeMeshData.texcoords
    );
    ...
    const elementBufferSource = createBufferSource(
      gl,
      gl.UNSIGNED_SHORT,
