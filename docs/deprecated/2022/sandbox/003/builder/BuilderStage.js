    ...
    uploadFile(['.wld'])
      ...
      .then((textData) => {
        ...
        for (let chunkData of jsonData.datas) {
          this.tileMap.chunkManager.loadChunk(
            this,
            chunkData.chunkId,
            chunkData.chunkX,
            chunkData.chunkY
...
export function update(dt) {
  ...
  let buildX =
    BuilderControls.BuildX.value * this.display.width - this.display.width / 2;
  let buildY =
    BuilderControls.BuildY.value * this.display.height -
