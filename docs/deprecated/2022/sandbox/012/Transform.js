export class Transform {
  ...
  get rotation() {
    return Math.asin(this.matrix[1]);
  }
  set rotation(value) {
    let scaleX = this.scaleX;
    let scaleY = this.scaleY;
  ...
  get scaleX() {
    return this.matrix[0] / Math.cos(this.rotation);
  }
  set scaleX(value) {
    this.matrix[0] = Math.cos(this.rotation) * value;
  }
  get scaleY() {
    return this.matrix[3] / Math.cos(this.rotation);
  }
  set scaleY(value) {
    this.matrix[3] = Math.cos(this.rotation) * value;
  }
