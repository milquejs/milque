...
export const POINTER_X = Camera2DControls.CONTEXT.registerRange(
  'x',
  'mouse[pos].x'
);
export const POINTER_Y = Camera2DControls.CONTEXT.registerRange(
  'y',
  'mouse[pos].y'
);
...
export function render(view) {
  ...
  drawWorldPointer(
    ctx,
    POINTER_X.value * view.width,
    POINTER_Y.value * view.height
  );
}
