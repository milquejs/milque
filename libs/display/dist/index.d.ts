...
declare class FlexCanvas extends HTMLElement {
    ...
    static create(opts?: {
        root?: HTMLElement;
        id?: string;
        mode?: FlexCanvasScaling;
        width?: number;
        height?: number;
        debug?: boolean;
    }): FlexCanvas;
    static define(customElements?: CustomElementRegistry, opts?: any): void;
    /**
     * @protected
     * Override for web component.
     */
    protected static get observedAttributes(): string[];
    set mode(arg: FlexCanvasScaling);
    /**
     * The scaling mode.
...
type FlexCanvasScaling = "center" | "fit" | "noscale" | "scale" | "fill" | "stretch";
...
export { DisplayPort, FlexCanvas, FlexCanvasScaling, FrameEvent, MODE_CENTER, MODE_FILL, MODE_FIT, MODE_NOSCALE, MODE_SCALE, MODE_STRETCH, ResizeEvent };
