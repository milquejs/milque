...
function createGame(scene)
{
    let result = {
        ...
        _renderStep(view, renderer = null, viewPort = null, renderContext = null, first = true)
        {
            ...
            {
                drawBufferToCanvas(_default.getDrawContext(), view.canvas);
            }
        }
    };
