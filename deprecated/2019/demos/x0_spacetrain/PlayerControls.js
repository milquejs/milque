...
export const MOVE_MAPPING = {
    ...
    down: [ { key: 'keyboard:ArrowDown', scale: 1 }, { key: 'keyboard:KeyS', scale: 1 } ],
    left: [ { key: 'keyboard:ArrowLeft', scale: 1 }, { key: 'keyboard:KeyA', scale: 1 } ],
    right: [ { key: 'keyboard:ArrowRight', scale: 1 }, { key: 'keyboard:KeyD', scale: 1 } ],
};
export const SHOOT_MAPPING = {
    pointx: { key: 'mouse:pos.x', scale: 1 },
    pointy: { key: 'mouse:pos.y', scale: 1 },
    point: [ { key: 'mouse:0', scale: 1 }, { key: 'mouse:2', scale: 1 } ],
};
