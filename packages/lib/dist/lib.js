(function (global, factory) {
    ...
    */
    ...
    {
        let result = {
            loop: new core.GameLoop(),
            scenes: new core.SceneManager(),
            ...
            _renderStep(view, renderer = null, viewPort = null, renderContext = null, first = true)
            {
                ...
                if (viewPort)
                {
                    core.View.drawBufferToCanvas(viewPort.getContext(), view.canvas, viewPort.getX(), viewPort.getY(), viewPort.getWidth(), viewPort.getHeight());
                }
                // TODO: Is there a way to get rid of this?
                else if (display.Display.getDrawContext())
                {
                    core.View.drawBufferToCanvas(display.Display.getDrawContext(), view.canvas);
                }
            }
        };
    ...
    class Camera2D extends core.AbstractCamera
    {
