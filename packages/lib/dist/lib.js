(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@milque/input'), require('@milque/entity'), require('@milque/display'), require('@milque/game'), require('@milque/util'), require('@milque/math')) :
    typeof define === 'function' && define.amd ? define(['exports', '@milque/input', '@milque/entity', '@milque/display', '@milque/game', '@milque/util', '@milque/math'], factory) :
    (global = global || self, factory(global.Lib = {}, global.input, global.entity, global.display, global.game$1, global.util, global.math));
}(this, (function (exports, input, entity, display, game$1, util, math) { 'use strict';
    ...
    */
    ...
    {
        let result = {
            loop: new game$1.GameLoop(),
            scenes: new SceneManager(),
            entities: new entity.EntityManager(),
            ...
            _renderStep(view, renderer = null, viewPort = null, renderContext = null, first = true)
            {
                ...
                else if (display.Display.getDrawContext())
                {
                    drawBufferToCanvas(display.Display.getDrawContext(), view.canvas);
                }
            }
        };
        result.loop.on('update', result.update.bind(result));
        result.scenes.on('preupdate', () => input.Input.poll());
    ...
    const CONTEXT$3 = input.Input.createContext();
