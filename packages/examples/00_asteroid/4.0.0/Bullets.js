...
export function update(dt, scene)
{
    ...
    for(let bullet of scene.bullets)
    {
        ...
        else
        {
            ...
            // Wrap around
            Lib.wrapAround(bullet, BULLET_RADIUS * 2, BULLET_RADIUS * 2);
        }
    }
    ...
    for(let bullet of scene.bullets)
    {
        ...
        {
            if (Utils.withinRadius(bullet, asteroid, asteroid.size))
            {
...
export function render(ctx, scene)
{
    ...
    for(let bullet of scene.bullets)
    {
        ...
        Lib.drawCollisionCircle(ctx, bullet.x, bullet.y, BULLET_RADIUS);
    }
}
