...
function (_InputDevice) {
  ...
  _createClass(Mouse, [{
    ...
    key: "setCursorLock",
    value: function setCursorLock(cursorLock) {
...
function Pointer() {
  ...
  return {
    ...
    get dx() {
      return this._dx.get(true);
    },

    get dy() {
      return this._dy.get(true);
    }
...
function Mover3D() {
  var forward = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'key[w]';
  var left = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'key[a]';
  var backward = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'key[s]';
  var right = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'key[d]';
  var up = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'key[e]';
  var down = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : 'key[c]';
  return {
    _forward: State().attach(forward),
    _left: State().attach(left),
    _backward: State().attach(backward),
    _right: State().attach(right),
    _up: State().attach(up),
    _down: State().attach(down),

    get forward() {
      return this._forward.get(false);
    },

    get backward() {
      return this._backward.get(false);
    },
...
export { CollisionModule as Collision, ColorHelper as Color, ControllerModule as Controller, DisplayModule as Display, EntityModule as Entity, Eventable, GAME as Game, InputModule as Input, MathHelper as Math, TweenModule as Tween, play };
